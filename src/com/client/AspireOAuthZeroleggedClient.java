...
public class AspireOAuthZeroleggedClient extends Thread{
	...
	public AspireOAuthZeroleggedClient(String baseURL) {
		this.baseURL = baseURL;
	}
	
	public AspireOAuthZeroleggedClient(String baseURL, String tenantId) {
		this.baseURL = baseURL;
	...
	private String initOAuthAccessConnection(String tenantId, String score) {
		...
		try {
			...
			if (!validAccessor) {
				...
				//provider = new OAuthServiceProvider(requestTokenURL, authorizeURL, accessTokenURL);
				provider = new OAuthServiceProvider(null, null, null);
				
				consumer = new OAuthConsumer(null, "yJM4cX9HeK13ldEG", "Pjw2uzTBTx2edJZk", provider);
				...
				if (client != null) {
					responseCheck = client.invoke(accessor, OAuthMessage.POST,
							serviceURL, map.entrySet());
				}
...
//			
	...
	/*public static void main (String args[]) {
		AspireOAuthZeroleggedClient clientAccess = new AspireOAuthZeroleggedClient(
				host, tenantId);
